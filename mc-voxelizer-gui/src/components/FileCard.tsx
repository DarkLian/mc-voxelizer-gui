...
import {
  MoreVertical, FolderOpen, FileSearch, Copy, Trash2,
  Terminal, CheckCircle2, AlertCircle, Clock, Loader2,
  PauseCircle, XCircle, Circle,
} from "lucide-react";
        ...
        <>
          ...
          >
            <MenuItem icon={<Terminal size={13} />} label="View Log"
              onClick={() => { openLogDrawer(file.id); setMenuOpen(false); }} />
