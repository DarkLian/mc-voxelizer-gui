...
import { detectLogLevel, progressFromLine, isPausePrompt } from "@/utils/logParser";
...
export function useConversionQueue() {
  ...
  const runFile = useCallback(async (fileId: string) => {
    const { files, preferences, addLogLine, setStatus, setPid, setProgress,
            setElapsed, finishFile, advanceQueue } = useAppStore.getState();
